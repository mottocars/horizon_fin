const { z } = require('zod');
const service = require('./zapi.service');
...
const createSchema = z.object({
  ...
  instance_token: z.string().min(1, 'Token da instância é obrigatório.'),
  client_token: z.string().min(1, 'Client-Token é obrigatório.'),
});
